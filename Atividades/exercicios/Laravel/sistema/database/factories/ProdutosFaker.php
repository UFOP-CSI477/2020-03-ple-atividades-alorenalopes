...
class ProdutosFaker extends \Faker\Provider\Base
{
    protected static $produtosNomes = [
        ...
        'Porção de Fritas', 'Porção de Contra Filé', 'Porção de Calabresa', 'Porção Mista',  'Cerveja Lata', 'Cerveja 600ml', 'Cerveja 1L',
        ...
        'Suco de Uva', 'Suco de Abacaxi', 'Suco de Laranja', 'Suco de Limão', 'Suco de Morango',  'Manteiga',
        'Ovo', 'Leite','Queijo','Nata','Mussarela','Iogurte','Creme', 'Leite', 'Quindim',
    ];

       

    protected static $unidadesMedidas = [
        'Kg', 'L', 'Pç',
    ];
     ...
     * @return string
     */
    public function produtosNomes()
    {
        return static::randomElement(static::$produtosNomes);
    }
    ...
    {
        return static::randomElement(static::$unidadesMedidas);
    }
}
